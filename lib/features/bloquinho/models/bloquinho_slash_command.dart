...
class BloquinhoSlashCommand {
  ...
  static List<BloquinhoSlashCommand> get allCommands => [
        ...
        BloquinhoSlashCommand(
          ...
          icon: PhosphorIcons.mathOperations(),
          markdownTemplate: '\$\$\\int_{a}^{b} f(x) dx\$\$',
          category: 'matematica',
          categoryColor: Colors.red,
        ),
        BloquinhoSlashCommand(
          ...
          icon: PhosphorIcons.mathOperations(),
          markdownTemplate: '\$\$\\sum_{i=1}^{n} x_i\$\$',
          category: 'matematica',
          categoryColor: Colors.red,
        ),
        BloquinhoSlashCommand(
          ...
          icon: PhosphorIcons.mathOperations(),
          markdownTemplate: '\$\$\\prod_{i=1}^{n} x_i\$\$',
          category: 'matematica',
          categoryColor: Colors.red,
        ),
        BloquinhoSlashCommand(
          ...
          icon: PhosphorIcons.mathOperations(),
          markdownTemplate: '\$\$\\lim_{x \\to \\infty} f(x)\$\$',
          category: 'matematica',
          categoryColor: Colors.red,
        ),
        BloquinhoSlashCommand(
          ...
          icon: PhosphorIcons.mathOperations(),
          markdownTemplate: '\$\$\\frac{d}{dx} f(x)\$\$',
          category: 'matematica',
          categoryColor: Colors.red,
        ),
        BloquinhoSlashCommand(
